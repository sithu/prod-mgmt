...
def create_Order():
    entity = Order.Order(
        ...
        , production_start_at = datetime.datetime.strptime(request.json['production_start_at'], "%Y-%m-%d").date()
        , production_end_at = datetime.datetime.strptime(request.json['production_end_at'], "%Y-%m-%d").date()
